<template>
  <div class="ma-12">
    <v-form class="ma-12" ref="form" v-model="valid" lazy-validation>
      ...
      <v-text-field class="mx-10" v-model="email" :rules="emailRules" label="E-mail" required></v-text-field>
      ...
      <div class="mx-10">
        <v-btn :disabled="!valid" color="success" class="mr-4" @click="cadastrar">Salvar</v-btn>
