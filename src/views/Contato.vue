  ...
  <v-list-item-group class="mx-2 my-4">
    <template v-for="(item, index) in items">
      <v-list-item :key="item.cliente">
        <v-list-item-content>
          <v-list-item-title class="title ml-3 mr-5"> Cliente: <v-list-item-title class="font-weight-light">{{item.cliente}}</v-list-item-title>
          </v-list-item-title>
          <v-container fluid>
            <v-row>
              <v-col cols="10">
                <v-list-item-title class="title ml-3 mr-5"> Assunto: <v-list-item-subtitle
